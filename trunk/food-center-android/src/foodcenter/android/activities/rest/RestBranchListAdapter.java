...
public class RestBranchListAdapter extends BaseAdapter implements OnClickListener
{
    ...
    public RestBranchListAdapter(Activity activity, RestaurantBranchProxy[] branches, String restId)
    {
        super();
