...
public class MainRestListAdapter extends BaseAdapter implements OnClickListener
{
    ...
    public MainRestListAdapter(Activity activity, DisplayImageOptions options, RestaurantProxy[] rests)
    {
        super();
    ...
    public void onClick(View view)
    {
        ...
        intent.putExtra(RestActivity.EXTRA_REST_ID, restId);
