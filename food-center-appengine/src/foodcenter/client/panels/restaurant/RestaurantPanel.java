...
public class RestaurantPanel extends PopupPanel implements RedrawablePanel
{
                                          ...
                                          PanelCallback<RestaurantBranchProxy, RestaurantBranchAdminServiceRequest>
    {
                 ...
                 PanelCallback<RestaurantBranchProxy, RestaurantBranchAdminServiceRequest> callback)
        {
            ...
            {
                branchService = RequestUtils.getRequestFactory().getRestaurantAdminService();
                      ...
                      PanelCallback<RestaurantBranchProxy, RestaurantBranchAdminServiceRequest> callback)
        {
            ...
            {
                admin = RequestUtils.getRequestFactory().getRestaurantAdminService(); // RestaurantAdmin
                                                                                      // on purpose!
            }

            blockingPopup.show();
            RestaurantBranchProxy newBranch = RequestUtils.createRestaurantBranchProxy(admin);
