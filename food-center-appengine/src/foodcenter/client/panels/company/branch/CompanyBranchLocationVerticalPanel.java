...
public class CompanyBranchLocationVerticalPanel extends VerticalPanel
{
    private final CompanyBranchProxy branchPrxoy;
    ...
    public CompanyBranchLocationVerticalPanel(CompanyBranchProxy branchPrxoy, boolean isEditMode)
    {
        super();
