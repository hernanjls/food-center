...
public abstract class AbstractRequestTest extends AbstractGAETest
{
	...
	protected CourseProxy createCourse(//
	...
	protected RestaurantBranchProxy createRestBranch(//
	    RequestContext service, //
	    ...
	    int numBranchMenuCatCourses)
	{
		...
		for (int j = 0; j < numBranchMenuCats; ++j)
		{
			...
			{
				CourseProxy course = createCourse(service, "branch_course" + Math.random(), 12.2 + 10 * Math.random());
	...
	protected RestaurantProxy createRest(//
	    RequestContext service, //
	    String name, //
	    int menuCats, //
	    int menuCatCourses, //
	...
	protected OrderProxy createOrder(RequestContext rContext, RestaurantBranchProxy branch, int maxCourses)
	{
